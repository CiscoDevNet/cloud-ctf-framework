...
def create_job_object():
    ...
    container = k8sclient.V1Container(
        name=JOB_NAME,
        image="containers.cisco.com/cloud-ctf/chall2-deploy",
...
def load(app):
    @app.route('/plugins/chall2-deploy-plugin', methods=['POST', 'GET'])
    def view_plugins_chall2_deploy():
        ...
        instances = ec2.instances.filter(
                Filters=[{'Name': 'instance-state-name', 'Values': ['running']},{'Name': 'tag:Name', 'Values': ['CloudCTFchall2']}])
        count=0
