...
def create_job_object():
    ...
    container = k8sclient.V1Container(
        name=JOB_NAME,
        image="containers.cisco.com/cloud-ctf/chall1-destroy",
...
def load(app):
    @app.route('/plugins/chall1-destroy-plugin', methods=['POST', 'GET'])
    def view_plugins_chall1_destroy():
